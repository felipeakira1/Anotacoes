...
# Este é um projeto incremental. A cada aula é pedido mais uma  deve enviar. O nome dos trparte.
# Aqui você deve entregar relativo às aulas 7 e 8.
# Em grupo de 3 pessoas. Apenas 1ês
# integrantes deve estar junto com o código fonte.
...
# haver uma pequena margem em branco do lado esquerdo, do lado direito, embaixo e acima.
